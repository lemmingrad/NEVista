...
#define WINSYS_WINDOW_CLASS_NOT_REGISTERED				(0x80000302)
#define WINSYS_WINDOW_HWND_NOT_CREATED					(0x80000303)
#define WINSYS_WINDOW_HDC_NOT_CREATED					(0x80000304)
#define WINSYS_WINDOW_PIXELFORMAT_NOT_FOUND				(0x80000305)
#define WINSYS_WINDOW_PIXELFORMAT_NOT_SET				(0x80000306)
#define WINSYS_WINDOW_HRC_NOT_CREATED					(0x80000307)				
#define WINSYS_WINDOW_HRC_NOT_ACTIVATED					(0x80000308)
